...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/pi/catkin_ws/src/rosbridge_suite/rosapi)
...
if(NOT "/home/pi/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/rosbridge_suite/rosapi/${idir}'.  ${_report}")
    endif()
